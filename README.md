...
I build end-to-end analytics and machine learning pipelines using wearable-style datasets (e.g., Fitbit-like activity and sleep data) to:
...
Before and alongside my technical work, I was a group fitness instructor, which strongly shapes my approach to digital health. This gave me hands-on experience with:
...
[stroke-supervision-tracking-dashboard](https://github.com/graceoko/stroke-supervision-tracking-dashboard)
